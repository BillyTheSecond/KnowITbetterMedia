...
<head>
    ...
    <title>KnowITbetter - Erreur 403</title>
...
?>
    ...
    <section id="top-page" class="iphone-padding">
        ...
        <div class="landing-page">
            <h1 class="big-title"><i class="fa-solid fa-face-frown-open"></i> 403 - Accès Interdit...</h1>
            <p style="text-align: center;font-size: 18px;">MAIS QUE FAITES VOUS ICI ! Ne seriez-vous pas en train d'essayer de nous dérober des informations super-secrètes ? [pas content]</p>
        </div>
    ...
    <section id="actions-disponibles-404">
        <div class="boutons flex-container" style="justify-content: center;padding-top: 10px;">
            ...
            <a class="button lien-sans-style" href="mailto:billy@knowitbetter.fr?subject=Rapport Erreur 404&body=Contact au sujet d'une erreur 403%0D%0A%0D%0AVotre nom :%0D%0APage recherchée:%0D%0A%0D%0AVOTRE MESSAGE ICI:%0D%0A%0D%0A"><i class="fa-solid fa-file-pen text-icon"></i> Nous envoyer un retour </a>

...
<head>
    ...
    <title>KnowITbetter - Erreur 400</title>
...
<?php  
    ...
    <section id="top-page" class="iphone-padding">
        ...
        <div class="landing-page">
            <h1 class="big-title"><i class="fa-solid fa-face-frown-open"></i> 400 - Mauvaise requête...</h1>
            <p style="text-align: center;font-size: 18px;">L'url rentrée n'est pas valide, vérifiez qu'il n'y ait pas de caractères spéciaux et actualisez la page.</p>
        </div>
    ...
    <section id="actions-disponibles-404">
        <div class="boutons flex-container" style="justify-content: center;padding-top: 10px;">
            ...
            <a class="button lien-sans-style" href="mailto:billy@knowitbetter.fr?subject=Rapport Erreur 400&body=Contact au sujet d'une erreur 404%0D%0A%0D%0AVotre nom :%0D%0APage recherchée:%0D%0A%0D%0AVOTRE MESSAGE ICI:%0D%0A%0D%0A"><i class="fa-solid fa-file-pen text-icon"></i> Nous envoyer un retour </a>
